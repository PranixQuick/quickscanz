    ...
    <div className="min-h-screen bg-cream-50">
      ...
      <nav className="max-w-2xl mx-auto px-5 py-5 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          <Link href="/login" className="text-sm text-ink-400 hover:text-ink-600 transition-colors">Sign in</Link>
      ...
      <section className="max-w-2xl mx-auto px-5 mb-16">
        <div className="grid grid-cols-3 gap-4">
          {[
            { n: "99+", label: "Products in catalog" },
            { n: "59", label: "Indian brands" },
            { n: "21", label: "Service centres" },
          ].map((s) => (
      ...
      {/* Features */}
      <section className="max-w-2xl mx-auto px-5 mb-16">
        <h2 className="font-display text-2xl font-light text-ink-900 mb-6 text-center">Everything in one place</h2>
        <div className="grid grid-cols-2 gap-3">
          {[
            ...
            { icon: "📍", title: "Service centres", desc: "Find authorized service centres near you for 6 major brands." },
