...
const sections = [
  ...
  { title: "9. AI Features & Third-Party Models", content: "The AI Claim Assistant feature uses third-party large language model APIs (including Anthropic Claude and/or compatible providers) to generate guidance text. Your product descriptions and claim context may be sent to these APIs to produce responses. No invoice images, payment details, or personal identity documents are included in AI requests. Data sent to AI providers is governed by their respective privacy policies and is not used to train their models. AI-generated responses are suggestions only and do not constitute legal or warranty advice." },
